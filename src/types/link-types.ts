...
// Threads Link Types
export type ThreadsLinkType = 'threads_post' | 'threads_profile';
...
// Discord Link Types
export type DiscordLinkType = 'discord_server_invite' | 'discord_message_link';
...
export type AppStoreLinkType = 'app_store_ios_app' | 'google_play_store_app';
